...
def home_view(request):
    ...
    headers = {
          'x-rapidapi-key': "3cc7320a5bmshca42fcf0e9fe194p16aa88jsn9a4c928dea16",
...
#
#     headers = {
#         'x-rapidapi-key': "c08a25e3c5msh1c991a3c012c27ep1a3212jsn60e55525c563",
...
def hotel_detail(request):
    ...
    querystring = {"checkIn": checkin, "locale": "en_US", "rooms": rooms, "checkOut": checkout,
                   "currency": "INR", "include": "neighborhood"}
    headers = {
        'x-rapidapi-key': "512e1df4demsh6c4b563b6204b0fp197436jsnbadde161ec60",
        'x-rapidapi-host': "hotels-com-free.p.rapidapi.com"
    }
    ...
    headers = {
        'x-rapidapi-key': "2c1eab4e8bmsh900e414353d749ep19b176jsn6a87b597539e",
...
def hotel_list(request):
    ...
    #
    # headers = {
    #     'x-rapidapi-key': "cdcaeaa0cemsh442f350f9c39ef2p13ae51jsn3194e6eb7da0",
    #     'x-rapidapi-host': "hotels-com-free.p.rapidapi.com"
    # }
    #
    # res = requests.request("GET", url, headers=headers, params=querystring)
